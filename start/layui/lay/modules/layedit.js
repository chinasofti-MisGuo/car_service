...
function style_html(t, e, i, n) {
	function a() {
		return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
			...
			else if("script" === l) this.record_tag(l), this.tag_type = "SCRIPT";
			else if("style" === l) this.record_tag(l), this.tag_type = "STYLE";
			else if("!" === l.charAt(0))
				if(-1 != l.indexOf("[if")) {
					if(-1 != a.indexOf("!IE")) {
					...
					this.tag_type = "START"
				} else if(-1 != l.indexOf("[endif")) this.tag_type = "END", this.unindent();
...
function js_beautify(t, e, i, n) {
	...
	function y() {
		...
		if(t > 1)
			for(var i = 0; i < 2; i++) l(0 === i);
		var n = 1 === t;
		if(f(e, E)) {
			if(K < h.length)
				for(; f(h.charAt(K), E) && (e += h.charAt(K), (K += 1) !== h.length););
		...
		if("/" === e) {
			...
			if("*" === h.charAt(K)) {
				if((K += 1) < h.length)
					for(;
						("*" !== h.charAt(K) || !h.charAt(K + 1) || "/" !== h.charAt(K + 1)) && K < h.length && (a += h.charAt(K), !((K += 1) >= h.length)););
		...
		if("'" === e || '"' === e || "/" === e && ("TK_WORD" === g && "return" === b || "TK_START_EXPR" === g || "TK_END_BLOCK" === g || "TK_OPERATOR" === g || "TK_EOF" === g || "TK_END_COMMAND" === g)) {
			...
			if(e = "", K < h.length)
				for(;
					(s || h.charAt(K) !== o) && (e += h.charAt(K), s = !s && "\\" === h.charAt(K), !((K += 1) >= h.length)););
	...
	var s = function(t, i, n) {
			...
			l.css({
				...
				var o = l.contents(),
					...
					d = o.find("body");
				r.append(c), d.attr("contenteditable", "true").css({
					"min-height": n.height
				}).html(i.value || ""), u.apply(a, [s, l, i, n]), m.call(a, s, t, n)
			})
		},
		r = function(t) {
								...
								layui.use("upload", function(o) {
									...
									o.render({
										...
										before: function(t) {
											...
											if(i.close(s), 0 == t.code) t.data = t.data || {}, c.val(t.data.src), r.val(t.data.name);
											else var a = i.open({
												type: 1,
												anim: 2,
												icon: 5,
												...
												area: ["390px", "260px"],
												offset: "t",
												content: "<br /><br /><div style='text-align:center;'><img src='" + t.data.src + "' style='max-height:80px'/></div><p style='text-align:center'>确定使用该文件吗？</p>",
												btn: ["确定", "取消"],
												yes: function() {
								...
								layui.use("upload", function(s) {
									...
									s.render({
										...
										before: function(t) {
											...
											if(i.close(r), 0 == t.code) t.data = t.data || {}, u.val(t.data.src);
											else var a = i.open({
												type: 1,
												anim: 2,
												icon: 5,
												...
												area: ["390px", "260px"],
												offset: "t",
												content: "<br /><br /><div style='text-align:center;'><img src='" + t.data.src + "' style='max-height:100px'/></div><p style='text-align:center'>确定使用该文件吗？</p>",
												btn: ["确定", "取消"],
												yes: function() {
										...
										before: function(t) {
											...
											if(i.close(r), 0 == t.code) t.data = t.data || {}, c.val(t.data.src);
											else var a = i.open({
												type: 1,
												anim: 2,
												icon: 5,
												...
												area: ["390px", "260px"],
												offset: "t",
												content: "<br /><br /><div style='text-align:center;'><video src='" + t.data.src + "' style='max-height:100px' controls='controls'/></div><p style='text-align:center'>确定使用该文件吗？</p>",
												btn: ["确定", "取消"],
												yes: function() {
										...
										s.render({
											...
											before: function(t) {
												...
												c.val(t.data.src);
													...
													area: ["390px", "260px"],
													offset: "t",
													content:  "<br /><br /><div  style='text-align:center;'><audio src='" + t.data.src + "' controls='controls'/></div><p style='text-align:center'>确定使用该文件吗？</p>",
													btn: ["确定", "取消"],
													yes: function() {
														t.data = t.data || {},
														c.val(t.data.src),
								...
								return layui.use("upload", function(t) {
									...
									t = layui.upload, t.render({
										...
										before: function(t) {
											...
											if(i.close(e), 0 == t.code) t.data = t.data || {}, l.val(t.data.src), a.val(t.data.name);
											else var s = i.open({
												type: 1,
												anim: 2,
												icon: 5,
